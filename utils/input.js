...
export function getInput() {
  ...
  return {
    ...
    brake,
    steer,
    handbrake:    !!keys['Space'] || !!keys['NumpadEnter'] || mobile.drift,
    handbrakeJust:   wasJustPressed('Space') || wasJustPressed('NumpadEnter'),
    driftBurst:      wasJustPressed('KeyE') || wasJustPressed('Enter') || mobile.doubleDriftJust,
