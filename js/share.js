...
export function buildShareText(result = {}) {
  ...
  return `Racing Sandbox 3D?êÏÑú ${modeName} ${trackName} Í∏∞Î°ù ${formattedTime} ?¨ÏÑ±! ?àÎèÑ ?ÑÏ†Ñ?¥Î¥ê: https://racinggame.fly.dev`;
}
...
export function createShareImageCanvas(result = {}) {
  ...
  ctx.fillText('Racing Sandbox 3D', 48, 72);
